...
format:
  html:
    ...
    # theme: flatly    # commentato xche dentro il sito eredita il tema globale
    toc: true
    toc-depth: 2
    toc-location: left
    toc-title: "Indice"
    # embed-resources: true   # NON attivare dentro il sito (rompe CSS condiviso).
                              # Per un HTML autocontenuto da condividere fuori dal sito:
                              # quarto::quarto_render("dashboard/bes/index.qmd",
                              #                       output_format = "html",
  ...
  # --- Output docx (commentato — ripristinabile togliendo i "#")
  # docx:
  #   toc: false
  #   toc-depth: 3
  #   toc-title: "Indice"
